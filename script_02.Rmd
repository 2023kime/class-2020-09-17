...
```{r Scene 1, include=TRUE}

# Imported the course enrollment data, cleaned up data, names it "en_fall_2020". The course with the highest enrollment is Principles of Economics with 559 students, and there are 151 students enrolled in both sections of Gov 50.
...
en_fall_2020<- (read_excel("raw_data/class_enrollment_summary_by_term_9-17-2020.xlsx", skip = 3)) %>% 
  ...
  filter(u_grad>10, course_id<20000)
en_fall_2020%>%
arrange(desc(u_grad))%>%
